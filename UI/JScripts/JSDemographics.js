...
$(document).ready(function () {
    ...
    //Cap- 2113
    document.getElementById('ctl00_C5POBody_txtProviderSearch')?.setAttribute("data-phy-Category", "");
    ...
    $('#ctl00_C5POBody_txtTribalAffn').attr('title', $('#ctl00_C5POBody_hdnTribalAffn').val());
...
function btnaddinsured(e) {
    ...
    //Cap- 2113
    var vCategory = document.getElementById("ctl00_C5POBody_txtProviderSearch").attributes['data-phy-Category'].value;
                ...
                if (e.value.toUpperCase() == "ADD") {
                    ...
                    for (var j = 0; j < tablelength; j++) {
                        ...
                        if ($('#tbodupolicyinfo tr')[j].childNodes[15].innerText == document.getElementById("ctl00_C5POBody_hdnpatinsuredid").value) {
                            ...
                            $('#tbodupolicyinfo tr')[j].childNodes[23].innerText = vCategory;
                            //Cap - 1369
                            //btnclearinsured(false);
                            setTimeout(btnclearinsured(false), 1000);
                        }
...
function Edit(e) {
    ...
    if (e.parentElement.parentElement.childNodes[6].innerText != "") {
        ...
        document.getElementById('ctl00_C5POBody_hdnCategory').value = e.parentElement.parentElement.childNodes[23].innerText;
...
$("#ctl00_C5POBody_txtProviderSearch").autocomplete({
    ...
    $("#ctl00_C5POBody_txtProviderSearch").css("color", "black").attr({ "data-phy-Category": "" });
...
function OpenAddPhysician() {
    ...
    $(top.window.document).find("#TabPhysicianLibrary").one("hidden.bs.modal", function (e) {
        ...
        if (PhyID != "" && PhyDetails.split("&")[4] != undefined) {
            ...
            //Cap - 2134
            document.getElementById("ctl00_C5POBody_txtProviderSearch").attributes['data-phy-gridname'].value = PhyDetails.split("&")[1].replace("~|", "&");
            document.getElementById("ctl00_C5POBody_txtProviderSearch").attributes['data-phy-details'].value = PhyDetails.split("&")[2].replace("~|", "&");
            document.getElementById("ctl00_C5POBody_txtProviderSearch").attributes['data-phy-npi'].value = PhyDetails.split("&")[3].replace("~|", "&");
            document.getElementById('ctl00_C5POBody_txtProviderSearch').value = PhyDetails.split("&")[4].replace("~|", "&");
            document.getElementById('ctl00_C5POBody_txtProviderSearch').disabled = true;
            document.getElementById('ctl00_C5POBody_txtProviderSearch').style.backgroundColor = "#BFDBFF";
    ...
    if (EditPhyId == '' || ProviderText == '') {
        ...
        $(top.window.document).find("#TabPhysicianLibrary").one("hidden.bs.modal", function (e) {
            ...
            if ( PhyDetails!= '' && PhyDetails.split("&")[4] != undefined) {
                ...
                document.getElementById("ctl00_C5POBody_txtProviderSearch").attributes['data-phy-npi'].value = PhyDetails.split("&")[3].replace("~|", "&");
                document.getElementById('ctl00_C5POBody_txtProviderSearch').value = PhyDetails.split("&")[4].replace("~|", "&");
                document.getElementById("ctl00_C5POBody_txtProviderSearch").attributes['data-phy-Category'].value = PhyDetails.split("&")[5].replace("~|", "&");
                document.getElementById('ctl00_C5POBody_txtProviderSearch').disabled = true;
                document.getElementById('ctl00_C5POBody_txtProviderSearch').style.backgroundColor = "#BFDBFF";
                localStorage.setItem("PhyDetails", "");
            }  
