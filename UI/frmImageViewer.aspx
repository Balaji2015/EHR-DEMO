<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="frmImageViewer.aspx.cs" Inherits="Acurus.Capella.UI.frmImageViewer" ValidateRequest="false" %>
...
<body onload=" {sessionStorage.setItem('StartLoading', 'false');StopLoadFromPatChart();}">
    <form id="form1" runat="server">
        ...
        <table style="width: 100%; height: 100%">
            ...
            <tr style="height: 100%">
                <%--<td style="width: 8%; height: 610px; overflow-y: hidden;">
                    <div runat="server" id="_plcImgsThumbs" style="height: 585px; overflow-y: scroll;"></div>
                    <br />
                </td>--%>
                <td style="width: 70%; height: 100%;">
                    <div style="margin-left: 123px" id="imgControls">
                        ...
                        <div id="divrotate" runat="server" style="display: inline-block">
                            ...
                            <i class="fa fa-download" id="Download" style="margin-left: 15px; cursor: pointer;" runat="server" title="Download" onclick="Download();"></i>&nbsp;&nbsp;           
            ...
            <tr id="trmesshistory" runat="server" visible="false">
                ...
                <td colspan="2" style="width: 100%;">
                    <asp:TextBox TextMode="MultiLine" ID="txtmessage" runat="server" Style="width: 340px; height: 60px; resize: none; margin-left: -875px" onkeypress="enablesave()" CssClass="spanstyle"></asp:TextBox>
                </td>
            ...
            <tr id="trmessage" runat="server" visible="false">
                ...
                <td colspan="2" style="width: 100%;">
                    <asp:TextBox TextMode="MultiLine" ID="txtmsghistory" runat="server" Style="width: 340px; height: 60px; resize: none; margin-left: -875px;" ReadOnly="true" CssClass="nonEditabletxtbox"></asp:TextBox>
                </td>
        ...
        <asp:HiddenField ID="hdnFileNameExam" runat="server" EnableViewState="false" />
        <asp:HiddenField ID="hdnFileName" runat="server" EnableViewState="false" />
        <asp:PlaceHolder ID="PlaceHolder1" runat="server">
            <asp:Button ID="hdnDownloadbtn" runat="server" Style="display: none" OnClick="hdnDownloadbtn_Click"/>
