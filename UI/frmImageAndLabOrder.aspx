...
<body onload="FormLoad();OpenNotificationPopUp('ORDER');">
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
                                ...
                                <td>
                                    ...
                                    <p class="verti " style="height: 90px; margin-top: -1em; width: 20px; margin-left: -2px;">
                                        <asp:HyperLink Style="position: absolute; width: 75px; font-weight: bold;"
                                            CssClass="verti" ID="lnkOrderList" runat="server" NavigateUrl="javascript: void(0);"
            ...
            <asp:HiddenField ID="hdnIsEncounterUpdate" Value="" runat="server" />
            ...
            <asp:HiddenField ID="hdnMovetoOrderSubmitId" runat="server" Value="" />
