...
<body onload=" {sessionStorage.setItem('StartLoading', 'false');StopLoadFromPatChart();}">
    <form id="tab" runat="server" style="font-size: 8px;">
        ...
        <input type="hidden" id="hdnFirstName" runat="server"/>
        <input type="hidden" id="hdnMI" runat="server"/>
        <input type="hidden" id="hdnLastName" runat="server"/>
        <input type="hidden" id="hdnNPI" runat="server"/>
