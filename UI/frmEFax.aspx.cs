...
namespace Acurus.Capella.UI
{
    public partial class frmEFax : System.Web.UI.Page
    {
        ...
        public static string GetFaxload()
        {
            ...
            var result = new { SenderName = ClientSession.UserName, SenderCompany = ClientSession.FacilityName, txtSenderMaskFax = SenderMaskFax, LookUpList = LookUpList, Nameoftheuser = Nameoftheuser, FaciltyName = ConfigurationManager.AppSettings["ClientName"].ToString(), FacilityAddress = FacilityAddress, FacilityPhoneNumber = FacilityPhoneNumber, FacilityFaxNumber = FacilityFaxNumber, Email = phyEmail };
