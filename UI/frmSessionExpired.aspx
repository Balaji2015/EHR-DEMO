<%@ Page  Async="true" Language="C#" AutoEventWireup="true" CodeBehind="frmSessionExpired.aspx.cs" Inherits="Acurus.Capella.UI.frmSessionExpired" %>
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <asp:Label ID="Label1" runat="server" Font-Bold="True" style="font-size:16px;"
                                    Text="Your session has expired, due to an extended period of inactivity" class="Editabletxtbox"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
