           ...
           if(EthnicityValue==string.Empty)
            {
                ...
                if (hn.Mothers_Maiden_Name != string.Empty)
                    ...
                    sResult = sResult + "\n" + "PID|1||" + hn.Id + "^^^NIST-MPI-1&2.16.840.1.113883.3.72.5.40.5&ISO^MR||" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L|" + hn.Mothers_Maiden_Name + "^^^^^^M|" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + sSex + "||" + RaceIdentifier + "^" + RaceValue + "^CDCREC|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^P||^PRN^PH^^^" + CityCode + "^" + LocalNumber + "|||||||||";
                else
                    //CAP-4015
                    ...
                    sResult = sResult + "\n" + "PID|1||" + hn.Id + "^^^NIST-MPI-1&2.16.840.1.113883.3.72.5.40.5&ISO^MR||" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L||" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + sSex + "||" + RaceIdentifier + "^" + RaceValue + "^CDCREC|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^P||^PRN^PH^^^" + CityCode + "^" + LocalNumber + "|||||||||";
            }
            else
            {
                if (hn.EMail == string.Empty)
                {
                    ...
                    if (hn.Mothers_Maiden_Name != string.Empty)
                        ...
                        sResult = sResult + "\n" + "PID|1||" + hn.Id + "^^^NIST-MPI-1&2.16.840.1.113883.3.72.5.40.5&ISO^MR||" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L|" + hn.Mothers_Maiden_Name + "^^^^^^M|" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + sSex + "||" + RaceIdentifier + "^" + RaceValue + "^CDCREC|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^P||^PRN^PH^^^" + CityCode + "^" + LocalNumber + "|||||||||" + EthnicityIdentifier + "^" + EthnicityValue + "^CDCREC" + "||" + hn.Birth_Indicator + "|" + hn.Birth_Order + "|||||" + sDeathIndicator;
                    else
                        //CAP-4015
                        ...
                        sResult = sResult + "\n" + "PID|1||" + hn.Id + "^^^NIST-MPI-1&2.16.840.1.113883.3.72.5.40.5&ISO^MR||" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L||" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + sSex + "||" + RaceIdentifier + "^" + RaceValue + "^CDCREC|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^P||^PRN^PH^^^" + CityCode + "^" + LocalNumber + "|||||||||" + EthnicityIdentifier + "^" + EthnicityValue + "^CDCREC" + "||" + hn.Birth_Indicator + "|" + hn.Birth_Order + "|||||" + sDeathIndicator;
                }
                else {
                    //CAP-1716,CAP-1719 - Immunization Submission to CAIR Records - To include PI(human_id ) for all  submissions instead of MRN Number 
                    //if (hn.Mothers_Maiden_Name != string.Empty)
