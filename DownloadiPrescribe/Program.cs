    ...
    public class Program
    {
        ...
        public static void CCDXmlGenerateAgent()
        {
            ...
            try
            {
                ...
                //Cap - 4115
                //string query = "select contact_id,h.human_id,e.Encounter_ID,w.Current_Arrival_Time,convert_tz(e.Date_of_Service,'Gmt','Us/Pacific') as Date_of_Service from patient_consent p left join human h on replace(p.contact_number,'Contact-','')=h.Dynamics_Number left join encounter e on h.human_id = e.Human_ID left join wf_object w on e.Encounter_ID = w.Obj_System_Id where ecm_consent_consent_for_participation_in_ecm ='true' and ecm_consent_decline_to_participate_in_ecm ='false' and ecm_consent_mental_health_information ='true' and ecm_consent_hiv_test_results ='true' and initial_here_to_allow_chaparral_medical_group  = 'true' and medical_authorization_all_records ='true' and date_patient_general_consent_and_medical  !='0001-01-01 00:00:00' and ((ecm_consent_standard_expiration = 'true'AND date_of_ecm_form_submission >= DATE_SUB(CURDATE(), INTERVAL 5 YEAR)) OR (ecm_consent_standard_expiration='false' and ecm_consent_early_expiration = 'true' AND this_authorization_will_expire <= CURDATE())) and h.Human_ID is not null and e.Facility_Name in " + Facility_Name + " and w.Obj_Type = 'Documentation' and w.Current_Process = 'Document_complete'  and w.Current_Arrival_Time >= '" + Convert.ToDateTime(dtGetDate.Rows[0]["Last_Generated_Date_Time"]).ToString("yyyy-MM-dd") + "' union select contact_id,h.human_id,e.Encounter_ID,w.Current_Arrival_Time,convert_tz(e.Date_of_Service,'Gmt','Us/Pacific') as Date_of_Service from patient_consent p left join human h on replace(p.contact_number,'Contact-','')=h.Dynamics_Number left join encounter_arc e on h.human_id = e.Human_ID left join wf_object_arc w on e.Encounter_ID = w.Obj_System_Id where ecm_consent_consent_for_participation_in_ecm ='true' and ecm_consent_decline_to_participate_in_ecm ='false' and ecm_consent_mental_health_information ='true' and ecm_consent_hiv_test_results ='true' and initial_here_to_allow_chaparral_medical_group  = 'true' and medical_authorization_all_records ='true' and date_patient_general_consent_and_medical  !='0001-01-01 00:00:00' and ((ecm_consent_standard_expiration = 'true'AND date_of_ecm_form_submission >= DATE_SUB(CURDATE(), INTERVAL 5 YEAR)) OR (ecm_consent_standard_expiration='false' and ecm_consent_early_expiration = 'true' AND this_authorization_will_expire <= CURDATE())) and h.Human_ID is not null and e.Facility_Name in" + Facility_Name + " and w.Obj_Type = 'Documentation' and w.Current_Process = 'Document_complete'  and w.Current_Arrival_Time >='" + Convert.ToDateTime(dtGetDate.Rows[0]["Last_Generated_Date_Time"]).ToString("yyyy-MM-dd") + "' ";
                string query = "select contact_id,h.human_id,e.Encounter_ID,w.Current_Arrival_Time,convert_tz(e.Date_of_Service,'Gmt','Us/Pacific') as Date_of_Service from patient_consent p left join human h on replace(p.contact_number,'Contact-','')=h.Dynamics_Number left join encounter e on h.human_id = e.Human_ID left join wf_object w on e.Encounter_ID = w.Obj_System_Id where ecm_consent_consent_for_participation_in_ecm ='true' and ecm_consent_decline_to_participate_in_ecm ='false' and ecm_consent_mental_health_information ='true' and ecm_consent_hiv_test_results ='true' and initial_here_to_allow_chaparral_medical_group  = 'true' and medical_authorization_all_records ='true' and date_patient_general_consent_and_medical  !='0001-01-01 00:00:00' and ((ecm_consent_standard_expiration = 'true'AND date_of_ecm_form_submission >= DATE_SUB(CURDATE(), INTERVAL 5 YEAR)) OR (ecm_consent_standard_expiration='false' and ecm_consent_early_expiration = 'true' AND this_authorization_will_expire <= CURDATE())) and h.Human_ID is not null and e.Facility_Name in " + Facility_Name + " and w.Obj_Type = 'Documentation' and w.Current_Process = 'Document_complete'  and w.Current_Arrival_Time >= '" + Convert.ToDateTime(dtGetDate.Rows[0]["Last_Generated_Date_Time"]).ToString("yyyy-MM-dd") + "'";
