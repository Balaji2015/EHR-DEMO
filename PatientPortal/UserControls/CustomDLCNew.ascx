<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomDLCNew.ascx.cs" Inherits="Acurus.Capella.PatientPortal.UserControls.CustomDLCNew" %>
...
<div>
    ...
    <tr>
        <td style="margin:0px; padding:0px;position:relative">
            <asp:TextBox ID="txtDLC" runat="server" CssClass="DlcClass" TextMode="MultiLine" Style="position: static;
               resize: none;cursor:default;" MaxLength="32767"
                spellcheck ="true" >                 
            </asp:TextBox>
        </td>
         <td style="margin:0px; padding:0px; width:20px;"  >
            <div class="col-6-btn margintop5px" id="dvpbdropdown">
