    ...
    public partial class HL7Generator
    {
        ...
        public string CreateImmunizationRegistryNISTQuery(Human hn, FillClinicalSummary ClinicalSummary, string sPrintFileName)
        {
            ...
            if (hn.Mothers_Maiden_Name != string.Empty)
                ...
                sResult = sResult + "\n" + "QPD|Z44^Request Evaluated History and Forecast^CDCPHINVS|IZ-1.1-2015|" + hn.Medical_Record_Number + "^^^NIST-MPI-1&2.16.840.1.113883.3.72.5.40.5&ISO^MR|" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L||" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + hn.Sex.Substring(0, 1) + "|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^P";
        ...
        public string CreateImmunizationRegistryNIST(Human hn, PhysicianLibrary Phy, FillClinicalSummary ClinicalSummary, string sPrintFileName)
        {
            ...
            if (EthnicityIdentifier == string.Empty)
            {
                if (hn.Mothers_Maiden_Name != string.Empty)
                    ...
                    sResult = sResult + "\n" + "PID|1||" + hn.Medical_Record_Number + "^^^NIST-MPI-1&2.16.840.1.113883.3.72.5.40.5&ISO^MR||" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L||" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + hn.Sex.Substring(0, 1) + "||" + RaceIdentifier + "^" + hn.Race + "^CDCREC|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^P||^PRN^PH^^^" + CityCode + "^" + LocalNumber + "|||||||||";
            }
            else
            {
                if (hn.EMail == string.Empty)
                {
                    if (hn.Mothers_Maiden_Name != string.Empty)
                        ...
                        sResult = sResult + "\n" + "PID|1||" + hn.Medical_Record_Number + "^^^NIST-MPI-1&2.16.840.1.113883.3.72.5.40.5&ISO^MR||" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L||" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + hn.Sex.Substring(0, 1) + "||" + RaceIdentifier + "^" + hn.Race + "^CDCREC|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^P||^PRN^PH^^^" + CityCode + "^" + LocalNumber + "|||||||||" + EthnicityIdentifier + "^" + hn.Ethnicity + "^CDCREC" + "||" + hn.Birth_Indicator + "|" + hn.Birth_Order + "|||||" + sDeathIndicator;
                }
                else
                    if (hn.Mothers_Maiden_Name != string.Empty)
            ...
            var ImmunizationHistoryList = (from p in ClinicalSummary.immunhistoryList where !ClinicalSummary.ImmunizationList.Any(i => i.Encounter_Id == p.Encounter_ID && (i.Given_Date).ToString("yyyy-MM-dd") == (p.Administered_Date!=""? Convert.ToDateTime(p.Administered_Date).ToString("yyyy-MM-dd"):Convert.ToDateTime("0001-01-01").ToString("yyyy-MM-dd")) && i.Procedure_Code == p.Procedure_Code) select p).ToList();
            if (ImmunizationHistoryList.Count > 0)
            {
                for (int i = 0; i < ImmunizationHistoryList.Count; i++)
                {
                    ...
                    if (ImmunizationHistoryList[i].Administered_Date != string.Empty)
        ...
        public string CreateImmunizationRegistry(Human hn, PhysicianLibrary Phy, FillClinicalSummary ClinicalSummary, string sPrintFileName)
        {
            ...
            if (hn.Patient_Account_External == string.Empty)
            {
                if (EthnicityIdentifier == string.Empty)
                {
                    sResult = sResult + "\n" + "PID|1||" + hn.Id + "^^^ACUR^PI||" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L|" + Mothers_Maiden_First_Name + "^" + Mothers_Maiden_Last_Name + "|" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + hn.Sex.Substring(0, 1) + "||" + RaceIdentifier + "^" + hn.Race + "^CDCREC|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^L||^PRN^PH^^^" + CityCode + "^" + LocalNumber + "|||||||||";
                }
                else
                {
                    sResult = sResult + "\n" + "PID|1||" + hn.Id + "^^^ACUR^PI||" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L|" + Mothers_Maiden_First_Name + "^" + Mothers_Maiden_Last_Name + "|" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + hn.Sex.Substring(0, 1) + "||" + RaceIdentifier + "^" + hn.Race + "^CDCREC|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^L||^PRN^PH^^^" + CityCode + "^" + LocalNumber + "|||||||||" + EthnicityIdentifier + "^" + hn.Ethnicity + "^CDCREC";
                }
            }
            else
            {
                if (EthnicityIdentifier == string.Empty)
                {
                    sResult = sResult + "\n" + "PID|1||" + hn.Id + "^^^ACUR^PI~" + hn.Patient_Account_External + "^^^MAA^SS||" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L|" + Mothers_Maiden_First_Name + "^" + Mothers_Maiden_Last_Name + "|" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + hn.Sex.Substring(0, 1) + "||" + RaceIdentifier + "^" + hn.Race + "^CDCREC|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^L||^PRN^PH^^^" + CityCode + "^" + LocalNumber + "^~^NET^^" + hn.EMail + "|||||||||";
                }
                else
                {
                    sResult = sResult + "\n" + "PID|1||" + hn.Id + "^^^ACUR^PI~" + hn.Patient_Account_External + "^^^MAA^SS||" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L|" + Mothers_Maiden_First_Name + "^" + Mothers_Maiden_Last_Name + "|" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + hn.Sex.Substring(0, 1) + "||" + RaceIdentifier + "^" + hn.Race + "^CDCREC|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^L||^PRN^PH^^^" + CityCode + "^" + LocalNumber + "^~^NET^^" + hn.EMail + "|||||||||" + EthnicityIdentifier + "^" + hn.Ethnicity + "^CDCREC";
