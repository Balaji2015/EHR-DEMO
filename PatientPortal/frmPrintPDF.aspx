...
<%@ Page  Async="true" Language="C#" AutoEventWireup="true" CodeBehind="frmPrintPDF.aspx.cs" Inherits="Acurus.Capella.PatientPortal.frmPrintPDF" %>
    ...
    <div>
        ...
        <telerik:RadMultiPage ID="RadMultiPage1" runat="server" Width="100%" SelectedIndex="0">
            <telerik:RadPageView ID="RadPageView1" runat="server" Height="100%" Width="100%">
                ...
                <div align="right">
                    <telerik:RadButton ID="btnprint" runat="server" AutoPostBack="false" Text="Print Chart" OnClientClicked="btnClick" ButtonType="LinkButton" CssClass="bluebutton"
                        Style="position: relative; -moz-border-radius: 3px; -webkit-border-radius: 3px; height:15px !important; padding: 4px 12px !important; font-size:12px !important" >
                    </telerik:RadButton>                    
                     <telerik:RadButton ID="btnSendfax" runat="server" Visible="false" AutoPostBack="false" Text="Send Fax" OnClientClicked="btnFaxClick" ButtonType="LinkButton" CssClass="bluebutton"
                         Style="position: relative; -moz-border-radius: 3px; -webkit-border-radius: 3px;height:15px !important; padding: 4px 12px !important; font-size:12px !important">
                    </telerik:RadButton>
                </div>
            </telerik:RadPageView>
