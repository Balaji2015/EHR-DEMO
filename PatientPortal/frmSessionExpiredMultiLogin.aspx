<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSessionExpiredMultiLogin.aspx.cs" Inherits="Acurus.Capella.PatientPortal.frmSessionExpiredMultiLogin" %>
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <asp:Label ID="Label1" runat="server" Font-Bold="True" style="font-size:16px;"
                                    Text="This session has expired since you logged in from another system." class="Editabletxtbox"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
