...
namespace Acurus.Capella.Core.DomainObjects
{
    ...
    public partial class User : BusinessBase<string>
    {
        ...
        [DataMember]
        public virtual string Is_All_Facilities
        {
            get { return _Is_All_Facilities; }
            set
            {
        ...
        [DataMember]
        public virtual string Is_EMail_Login_Mandatory
        {
            get { return _Is_EMail_Login_Mandatory; }
            set
            {
