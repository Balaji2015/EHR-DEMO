...
namespace Acurus.Capella.Core.DomainObjects
{
    [Serializable]
    [DataContract]
    public partial class Blob_Progress_Note : BusinessBase<ulong>
    {
        #region Declarations
        //private ulong _Encounter_ID = 0;
        private ulong _Human_ID = 0;
        private byte[] _Progress_Note_Json = null;
        ...
        [DataMember]
        public virtual byte[] Progress_Note_Json
        {
            get { return _Progress_Note_Json; }
            set { _Progress_Note_Json = value; }
        }
